...
中学・高校時代はひたすら動画編集をしており、AviutlとMMDを駆使し、艦これの動画を作成してはニコニコ動画にアップロードしていた。(当時は父親が持っていたWindowsXP, Core2DuoのPCを使い、動画のエンコーディングに10時間程度要していたことから、夜中に動画のエンコーディングを開始し、朝起きてきちんとエンコーディングされたかどうかを確認するのが日課だった。高校入学のタイミングでcorei5, グラボのついたPCを親に購入してもらったのでこの日課はなくなった。)

また、基本情報技術者試験を受けるも、午後問題の選択のマークをし忘れるという痛恨のミスにより採点では合格していたものの試験に落ちる。以降高校卒業まであだ名がマークミスだった。そのこともあり、大学は情報系ではなく経営学部を専攻することにした。
